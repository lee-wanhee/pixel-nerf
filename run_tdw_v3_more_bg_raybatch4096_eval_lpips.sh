...
python eval/eval.py -n tdw_v3_more_bg_train_raybatch4096 -c conf/exp/tdw.conf \
    -D /ccn2/u/honglinc/datasets/tdw_playroom_v3_more_bg_eval --gpu_id='0' \
    -P '0' -O eval_out/tdw_test_include_svg_120323 \
    --frame5 \
    --n_scenes 9039 --skip 0 --fixed_locality --n_img_each_scene 4 \
    --debug_vis_path checkpoints_test_svg_120323 --no_shuffle \
