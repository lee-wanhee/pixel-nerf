#!/bin/bash
python eval/eval.py -n tdw_v3_stacking_train_raybatch4096_fromscratch -c conf/exp/tdw.conf \
    -D /ccn2/u/honglinc/datasets/tdw_playroom_v3_stacking_val --gpu_id='0' \
    -P '0' -O eval_out/tdw_v3_stacking_raybatch4096_fromscratch_120723 \
    --frame5 \
    --n_scenes 9039 --skip 0 --fixed_locality --n_img_each_scene 4 \
    --debug_vis_path vis_tdw_v3_stacking_raybatch4096_fromscratch_120723 --no_shuffle \
