#!/bin/bash
python eval/eval.py -n tdw_v3_more_bg_train_raybatch4096 -c conf/exp/tdw.conf \
    -D /ccn2/u/honglinc/datasets/tdw_playroom_v3_more_bg_val --gpu_id='0' \
    -P '0' -O eval_out/tdw_v3_more_bg_train_raybatch4096_121123_includesrc \
    --frame5 \
    --n_scenes 9039 --skip 0 --fixed_locality --n_img_each_scene 4 \
    --debug_vis_path vis_tdw_v3_more_bg_121123_includesrc --no_shuffle \
