from msn_utils.nerf import get_extrinsic, transform_points
from msn_utils.common import get_rank, get_world_size
...
class MultishapenetDataset(IterableDataset):
    def __init__(self, path, mode, points_per_item=8192, max_len=None, canonical_view=True,
        ...
        self.path = path # '/data3/wanhee/MultishapeNet'
...
# if __name__=='__main__':
    # dset = MultishapenetDataset(path='/data2/wanhee/srt/data/msn/', mode='train')
    # for result in dset:
    #     breakpoint()
